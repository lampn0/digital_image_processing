...
img = mpimg.imread("image-filtering\\output\\original.jpg")
...
All Comparisons were done using "No Reference Image Quality Assessment".
Non Local Mean was found best among all filters.
However, all filters give the good results and scores given by them are close to each others scores.
"""
